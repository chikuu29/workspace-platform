        ...
        <Box>
            <Box mx="auto" px="8">
                ...
                <StepsRoot step={step} onStepChange={(e) => setStep(e.step)} count={3} variant="subtle" colorPalette="blue">
                    <Box bg={sidebarBg} roundedTop="2xl" roundedBottom="none" shadow="md" border="1px solid" borderColor={borderColor} overflow="hidden">
                        <StepsList gap="0">
                            <StepsItem
                                index={0}
                                title="Personal"
                    ...
                    <Box
                        ...
                        rounded={'sm'}
                        // roundedTop="none" roundedBottom="2xl"
                        shadow="xl"
                        p="10"
                    >
                        ...
                        <StepsContent index={0}>
                            <Stack gap="12">
                                ...
                                <Flex align="center" gap="8" p="6" bg={sectionBg} rounded="2xl" border="1px dashed" borderColor={borderColor}>
                        ...
                        <StepsContent index={2}>
                            <Stack gap="8">
                                ...
                                <Box bg={sectionBg} p="6" rounded="lg" border="1px solid" borderColor={borderColor}>
                                    <Stack gap="4">
                                        <Flex justify="space-between" align="center">
                                            <Box>
                                                ...
                                                <Text fontSize="3xl" fontWeight="bold">$108.00</Text>
                                            </Box>
                                            <Box textAlign="right">
                    ...
                    {step < 3 && (
                        <Box p={2} shadow="xl" roundedTop="none" roundedBottom="2xl" border="1px solid" borderColor={separatorColor}>
                            <Flex justify="space-between" align="center">
                                <Box>
                                    {step > 0 && (
                                        <StepsPrevTrigger asChild>
                                            <Button variant="ghost" size="lg" px="8">
                                                Back to {step === 1 ? "Personal" : "Membership"}
                                            </Button>
                                        </StepsPrevTrigger>
                                    )}
                                </Box>
                                <HStack gap="4">
                                    ...
                                    {step < 2 ? (
                                        <StepsNextTrigger asChild>
                                            <Button variant="brand" size="lg" px="12" shadow="md">
                                                Continue to {step === 0 ? "Membership" : "Payment"}
                                            </Button>
                                        </StepsNextTrigger>
                                    ) : (
                                        <Button variant="brand" size="lg" px="12" shadow="lg" onClick={() => setStep(3)}>
