...
import { Steps, Box, Heading, Container, Text, Button, Stack, Icon, createIcon } from '@chakra-ui/react';
          ...
          asChild><Box>
            ...
            <Stack
              ...
              <Button
                ...
                asChild><Link to={"/auth/getstarted"}>Get Started
                            </Link></Button>
              <Button variant={'link'} colorPalette={'blue'} size={'sm'}>
                Learn more
              </Button>
              <Box>
                <Icon
